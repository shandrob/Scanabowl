...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return pageMeta(lang, "/terms", t("terms.metaTitle"), t("terms.metaDescription"));
}
...
export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <LongPage title={t("terms.title")} intro={t("terms.intro")} updated={t("legal.updated", { date: "2026-09-21" })} sections={createRaw(dict)("terms.sections")}>
      <section>
